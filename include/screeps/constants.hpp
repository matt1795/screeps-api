...
namespace Screeps {
    namespace {
        ...
        std::pair<Structure::Type, char const*> const structureData[] = {
            std::make_pair(Structure::Type::Spawn, "spawn"),
            std::make_pair(Structure::Type::Extension, "extension"),
            std::make_pair(Structure::Type::Road, "road"),
            std::make_pair(Structure::Type::Wall, "constructedWall"),
            std::make_pair(Structure::Type::Rampart, "rampart"),
            std::make_pair(Structure::Type::KeeperLair, "keeperLair"),
            std::make_pair(Structure::Type::Portal, "portal"),
            std::make_pair(Structure::Type::Controller, "controller"),
            std::make_pair(Structure::Type::Link, "link"),
            std::make_pair(Structure::Type::Storage, "storage"),
            std::make_pair(Structure::Type::Tower, "tower"),
            std::make_pair(Structure::Type::Observer, "observer"),
            std::make_pair(Structure::Type::PowerBank, "powerBank"),
            std::make_pair(Structure::Type::PowerSpawn, "powerSpawn"),
            std::make_pair(Structure::Type::Extractor, "extractor"),
            std::make_pair(Structure::Type::Lab, "lab"),
            std::make_pair(Structure::Type::Terminal, "terminal"),
            std::make_pair(Structure::Type::Container, "container"),
            std::make_pair(Structure::Type::Nuker, "nuker")};

        std::pair<Structure::Type, int> const structureCostData[] = {
            std::make_pair(Structure::Type::Spawn, 15000),
            std::make_pair(Structure::Type::Extension, 3000),
            std::make_pair(Structure::Type::Road, 300),
            std::make_pair(Structure::Type::Wall, 1),
            std::make_pair(Structure::Type::Rampart, 1),
            std::make_pair(Structure::Type::Link, 5000),
            std::make_pair(Structure::Type::Storage, 30000),
            std::make_pair(Structure::Type::Tower, 5000),
            std::make_pair(Structure::Type::Observer, 8000),
            std::make_pair(Structure::Type::PowerSpawn, 100000),
            std::make_pair(Structure::Type::Extractor, 5000),
            std::make_pair(Structure::Type::Lab, 50000),
            std::make_pair(Structure::Type::Terminal, 100000),
            std::make_pair(Structure::Type::Container, 5000),
            std::make_pair(Structure::Type::Nuker, 100000)};
